...
WebUI.setText(findTestObject('Analisa Data Mandiri/textboxKodeBU_PKS'), '110200101')
...
WebUI.verifyElementPresent(findTestObject('Analisa Data Mandiri/elementDataTidakTersedia'), 0)

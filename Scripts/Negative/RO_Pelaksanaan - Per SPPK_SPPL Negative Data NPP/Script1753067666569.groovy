...
WebUI.setText(findTestObject('Pemeriksaan - Perencanaan/textboxPencarianBadanUsaha'), GlobalVariable.kodeBU_Negative, FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Pemeriksaan - Perencanaan/textboxSPT'), (GlobalVariable.kodeBU_Negative + 'SPT') + formattedDate)

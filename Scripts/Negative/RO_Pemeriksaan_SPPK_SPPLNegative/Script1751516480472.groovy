...
WebUI.callTestCase(findTestCase('Negative/RO_AnalisaDataMandiriPreReq'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Pemeriksaan - Perencanaan/textboxPencarianBadanUsaha'), '11111111', FailureHandling.STOP_ON_FAILURE)
...
WebUI.comment('Kembali ke Kode BU benar, Test Negative case berikutnya')

WebUI.click(findTestObject('Inquiry Data/btnMorePilihBadanUsaha'))

WebUI.selectOptionByValue(findTestObject('Inquiry Data/dropdownPilihOpsiPencarianBadanUsaha'), '2', false)

WebUI.setText(findTestObject('Pemeriksaan - Perencanaan/textboxPencarianBadanUsaha'), GlobalVariable.kodeBU_backup, FailureHandling.STOP_ON_FAILURE)
...
WebUI.comment('Negative : Hapus Anggota dan Add Unknown Anggota')

WebUI.click(findTestObject('Pemeriksaan - Perencanaan/buttonHapusAnggotaRencanaSPPKLastRow'))

WebUI.setText(findTestObject('Pemeriksaan - Perencanaan/textboxSusunanTim'), '001')

WebUI.click(findTestObject('Pemeriksaan - Perencanaan/btnTambahTim'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Pemeriksaan - Perencanaan/btnTambahTim'), FailureHandling.STOP_ON_FAILURE)

WebUI.comment('Tidak Ada Alert untuk data anggota yang not found ??')
